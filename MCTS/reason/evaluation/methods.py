...
def vanila_mcts(
    ...
    traj_list = search_tree.vanila_mcts(
        ...
        group_id=problem_inst["group_id"],
        save_step_dir=problem_inst["save_step_dir"],
        save_refine_dir=problem_inst.get("save_refine_dir", None),
        target_length=problem_inst.get("target_length", None)
    )
